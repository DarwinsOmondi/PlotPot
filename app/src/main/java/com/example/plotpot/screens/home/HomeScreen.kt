...
fun HomeScreen(navHostController: NavHostController) {
    ...
    val challengeViewModel: ChallengeViewModel = viewModel(factory = PlotPotViewModelFactory(supabase))
    val contributionViewModel: ContributionViewModel = viewModel(factory = PlotPotViewModelFactory(supabase))
    ...
    contributionViewModel.fetchRecentContributions() // Fetch recent contributions
...
@Composable
fun ContributionCard(contribution: ContributionWithDetails, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
        ...
        Column(
            ...
            Text(
                text = "Contribution by ${contribution.username}",
                fontSize = 16.sp,
                fontWeight = FontWeight.Bold,
                color = Color.Black
            )
            ...
            Text(
                text = "Story: ${contribution.storyTitle}",
                fontSize = 14.sp,
                color = Color.Gray
            )
            Spacer(modifier = Modifier.height(4.dp))
